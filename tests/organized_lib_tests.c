...
Test(count_power, zero_as_value)
{
...
Test(my_strcmp, basic_my_strcmp_test)
{
    int result = my_strcmp("salut", "salut");
    cr_assert_eq(result, 0);
}

Test(my_strcmp, str1_minus_str2)
{
    int result = my_strcmp("salut", "salutsalut");
    cr_assert(result < 0);
}

Test(my_strcmp, capital_letter)
{
    int result = my_strcmp("SALUT", "SALUT");
    cr_assert_eq(result, 0);
}

Test(my_strdup, classic_strdup_test)
{
    char *string = "salut";
    char *string2 = my_strdup(string);

    cr_assert_str_eq(string, string2);
    free(string2);
}

Test(my_strlowcase, classic_strlowcase_test)
{
    char *string = my_strdup("SALUT");
...
Test(my_strnum, classic_strnum_test)
{
    int number = 42;
    char *string = my_strnum(number);

    cr_assert_str_eq(string, "42");
    free(string);
}